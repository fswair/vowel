...
Welcome to the Vowel framework documentation.
...
- **Getting Started**: See [User Guide - Quick Start](./USERGUIDE.md#quick-start)
- **YAML Format**: See [User Guide - YAML Format](./USERGUIDE.md#yaml-specification)
